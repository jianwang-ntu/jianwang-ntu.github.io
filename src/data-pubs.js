...
export const PUB_META = {
  ...
  C5: {
    ...
    brief: "Provides 248 buggy functions and 102 vulnerable functions with reproduction tests, then evaluates 24 LLMs on C/C++ repair.",
  ...
  C4: {
    ...
    brief: "Studies execution traces in fine-tuning and inference, finding limited usefulness in the evaluated code-model settings.",
  ...
  C2: {
    ...
    brief: "Evaluates 13 AI-generated-content detectors on code-related Q&A, summarization, and code generation from three language models.",
    abstract: null,
  ...
  C0: {
    ...
    abstract: "RNNRepair uses an influence model to analyze recurrent-network errors and identify relevant training examples. It estimates influence for both complete sequences and individual segments, then uses those relationships to guide repairs. The paper evaluates whether this model explains erroneous predictions and helps correct them in the studied tasks. These results concern RNN diagnosis and repair; they do not establish reliability for general-purpose agents.",
