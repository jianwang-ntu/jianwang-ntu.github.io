...
export const WORK_PROJECTS = [
  ...
  { id: 'xiaomi-emoji', title: 'Xiaomi · GAN-generated emoji', room: 'vision', type: 'industry', startYear: 2017, endYear: 2019,
    affiliation: 'Xiaomi AI Lab', status: 'TODO',
    skills: ['GANs', 'PyTorch', 'Computer vision', 'Model deployment'],
    summary: 'Personalised emoji and face cartoonisation from a selfie.',
    detail: 'Industry work on generative models for consumer handsets. The project case study, visual examples and implementation details will be added soon.', links: [] },
  { id: 'xiaomi-portrait', title: 'Xiaomi · Portrait processing', room: 'vision', type: 'industry', startYear: 2017, endYear: 2019,
    ...
    detail: 'Worked on portrait pipelines and model deployment, including quantisation and conversion for mobile inference. A detailed case study will be added soon.', links: [] },
  { id: '58-web', title: '58.com · Async web framework', room: 'systems', type: 'industry', startYear: 2011, endYear: 2017,
    affiliation: '58.com · Mobile Web', status: 'TODO',
    ...
    detail: 'Backend and mobile-web engineering focused on request handling, reliability and scalability. The architecture, engineering decisions and full case study will be added soon.', links: [] },
